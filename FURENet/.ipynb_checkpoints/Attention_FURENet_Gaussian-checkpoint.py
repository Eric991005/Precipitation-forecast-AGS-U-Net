...
from FURENet.GaussianSmoothing import GaussianSmoothing
...
class FURENet(nn.Module):
    def __init__(self, in_channels: int):
        ...
        self.gaussian_smoothing = GaussianSmoothing(channels=in_channels, kernel_size=5, sigma=1)
    ...
    def forward(self, z: Tensor, zdr: Tensor, kdp: Tensor, out_len: int = 10):
        ...
        out = self.gaussian_smoothing(out)  # 应用高斯平滑
